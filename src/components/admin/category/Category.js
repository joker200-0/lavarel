...
function Category() {
    ...
    const handleInput = (e) => {
        //Việc gọi event.persist()
        //sự kiện tổng hợp sẽ xóa sự kiện khỏi nhóm cho phép các tham chiếu đến sự kiện được giữ lại một cách không đồng bộ.
        e.persist();
            ...
            <div className="card mt-4">
                <div className="card-header">
                    <h4 className="mt-4">Add Category
                        <Link to="/admin/view-category" className="btn btn-primary btn-sm float-end" >ViewCategory</Link>
                    </h4>
                </div>
