...
function Checkout()
{
    //useHistorycung cấp cho bạn quyền truy cập vào history
    ...
    //khởi tạo ra đối tượng với những giá trị rỗng 
    ...
    useEffect(() => {
        ...
        let isMounted = true;
        //lấy dữ liệu từ api về và đưa vào biến request 
    ...
    //biến nhận dữ liệu để xử lý xử kiện
    const handleInput = (e) => {
        e.persist();
